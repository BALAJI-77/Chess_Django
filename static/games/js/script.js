...
let p1time = document.getElementById('min1') !=null ? new Timer('min1', document.getElementById('min1').textContent) : 0;
let p2time = document.getElementById('min2') !=null ? new Timer('min2', document.getElementById('min2').textContent) : 0;
